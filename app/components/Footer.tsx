          ...
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                ...
                <a href="https://www.facebook.com/MNLKINGPINQUEZON" target="_blank" rel="noopener noreferrer" style={{ fontSize: '12px', color: '#555', textDecoration: 'none' }}>MNL Kingpin Quezon</a>
              </div>
              {/* Instagram */}
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                <svg width="13" height="13" viewBox="0 0 24 24" fill="#555">
                ...
                <a href="https://www.instagram.com/mnlkingpin" target="_blank" rel="noopener noreferrer" style={{ fontSize: '12px', color: '#555', textDecoration: 'none' }}>MNL KINGPIN QUEZON</a>
              </div>
            </div>
          </div>
